...
import { ConditionEditor } from "@/features/search/ui/condition-editor";
import {
  fetchSearchMetadata,
...
import { useSearchLifecycle } from "@/features/search/hooks/use-search-lifecycle";
...
export function SearchBuilder() {
  ...
  if (metadataQuery.isPending) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm" role="status">
